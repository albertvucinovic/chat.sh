...
class ChatClient:
    def __init__(self):
        ...
        if self.current_model_key not in self.models_config:
            self.console.print(f"[bold yellow]Warning: Initial model '{self.current_model_key}' not in models.json.[/bold yellow]")
    ...
    def _initialize_system_prompt(self):
        ...
        self.console.print(Panel(system_prompt_string, title="[bold cyan]System Prompt[/bold cyan]", border_style=self.get_border_style("dim")))
